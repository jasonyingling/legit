 ...
 * @since 1.0.0
 */
class Legit_Walker_Comment extends Walker_Comment {
				...
				<footer class="comment-meta">
					<div class="comment-author vcard">
						<?php
							 ...
							 */
							if ( legit_is_comment_by_post_author( $comment ) ) {
								/* translators: %s: SVG Icon */
								printf( '<span class="post-author-badge" aria-hidden="true">%s</span>', legit_get_icon_svg( 'check', 18 ) );
							}
                        ...
                        <span class="comment-metadata">
                            <a href="<?php echo esc_url( get_comment_link( $comment, $args ) ); ?>">
                                ...
                                <time datetime="<?php comment_time( 'c' ); ?>" title="<?php printf( __( '%1$s at %2$s', 'legit' ), get_comment_date( '', $comment ), get_comment_time() ); ?>">
                                    <?php printf( __( '%1$s at %2$s', 'legit' ), get_comment_date( '', $comment ), get_comment_time() ); ?>
                                </time>
                            </a>
                            <?php
